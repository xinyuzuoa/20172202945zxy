  ...
  <body background="images/welcome.jpeg">
    <%
    	...
    	if(customName.equals("")){
    		response.sendRedirect("updateSearch0.jsp");
    	}
    	else{
    		try{
    			Class.forName("com.mysql.jdbc.Driver");
   				...
   				String sql = "update custom set customName='"+customName+"',cusTelephone='"+cusTelephone+"',cusAddress='"+cusAddress+"',cusCertain='"+cusCertain+"'where cusCertain='"+cusCertain+"'";
