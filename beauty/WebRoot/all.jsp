    	...
    	<div align="center">
            ...
            <div align="center">
                <%
                  ...
                  {
                    %>
                &nbsp;<a href="all.jsp?page=1">首页</a>&nbsp;
                &nbsp;<a href="all.jsp?page=<%=intPage-1%>">上一页</a>&nbsp;
                <%
                    if(intPage >3)
                    {
                %>
                ...
                <%
                    ...
                    {
                %>
                &nbsp;<a href="all.jsp?page=<%=intPage-2%>"><%=intPage-2%></a>&nbsp;
                <%
                    }
                %>
                &nbsp;<a href="all.jsp?page=<%=intPage-1%>"><%=intPage-1%></a>&nbsp;
                <%
                  }
                %>
                &nbsp;<a href="all.jsp?page=<%=intPage%>" style="color: red"><%=intPage%></a>&nbsp;
                <%
                    if(intPage<intPageCount){
                %>
                &nbsp;<a href="all.jsp?page=<%=intPage+1%>"><%=intPage+1%></a>&nbsp;
                ...
                %>
                &nbsp;<a href="all.jsp?page=<%=intPage+1%>">下一页</a>&nbsp;
                &nbsp;<a href="all.jsp?page=<%=intPageCount%>">尾页</a>&nbsp;
                <%
                    }
                %>
                &nbsp;共<%=intPageCount%>页
