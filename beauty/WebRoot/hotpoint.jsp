...
<html>
  ...
  <header id="header">
<%
String uname=(String)session.getAttribute("customName");
if(session.getAttribute("customName")==null){
	out.print("<h1>"+"嘿！今天你精致了嘛？"+"</h1>");
    out.print("<h3>———变美之路从现在开始！</h3>");
}
else{
	out.print("<h1>"+session.getAttribute("customName")+"嘿！今天你精致了嘛？"+"</h1>");
    out.print("<h3>———变美之路从现在开始！</h3>");
}     
        %>
  	...
  	<div class="nav">
  		...
  		<div>
  			<a href="hotpoint.jsp" style="font-weight:bold">热门</a> 			
  		</div>
  		<div>
    ...
    <div class="content">
			<button type="submit" class="indexbtn"><a href="addhotpoint.jsp">发布动态</a></button>
			<%
			...
			rs.last(); 
     		...
     		if(intPage>intPageCount)
			   ...
			   while(i<intPageSize && !rs.isAfterLast() && rs.getString("flag").equals("y")){
			 %>
			 <div class="item">
				<div class="itemtxt">
					发表人:
    ...
    <div class="instruction">
        <ul>
         ...
         <!-- 音乐播放 -->
        <div class="music" style="width:200px;">
        <div style="margin-left:50px;">
        	<p><img src="images/buy.jpg"></p>
        	<p>歌名：买买买</p>
        	<p>歌手：陈妍希</p>
        	</div>
        	<div class="Audio">
                <audio src="music/buybuy.mp3" controls autoplay loop >您的浏览器不支持audio标签。</audio>
                 <!-- 音乐播放控件：controls  自动播放：autoplay  循环播放：loop-->
            </div>     
        </div>
        </div>
  </body>
