  ...
  <form action="searchCheck.jsp">
  	...
  	<h2 align="center">香水类信息</h2>
		...
		<thead>	
			...
			String sql="select * from cusbeauty where petCategory = 'water'";
    	...
    	<div align="center">
            ...
            <div align="center">
                <%
                  ...
                  {
                    %>
                &nbsp;<a href="pig.jsp?page=1">首页</a>&nbsp;
                &nbsp;<a href="pig.jsp?page=<%=intPage-1%>">上一页</a>&nbsp;
                <%
                    if(intPage >3)
                    {
                %>
                ...
                <%
                    ...
                    {
                %>
                &nbsp;<a href="pig.jsp?page=<%=intPage-2%>"><%=intPage-2%></a>&nbsp;
                <%
                    }
                %>
                &nbsp;<a href="pig.jsp?page=<%=intPage-1%>"><%=intPage-1%></a>&nbsp;
                <%
                  }
                %>
                &nbsp;<a href="pig.jsp?page=<%=intPage%>" style="color: red"><%=intPage%></a>&nbsp;
                <%
                    if(intPage<intPageCount){
                %>
                &nbsp;<a href="pig.jsp?page=<%=intPage+1%>"><%=intPage+1%></a>&nbsp;
                ...
                %>
                &nbsp;<a href="pig.jsp?page=<%=intPage+1%>">下一页</a>&nbsp;
                &nbsp;<a href="pig.jsp?page=<%=intPageCount%>">尾页</a>&nbsp;
                <%
                    }
                %>
                &nbsp;共<%=intPageCount%>页
