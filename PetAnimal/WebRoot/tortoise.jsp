...
<style>
  ...
  <form action="searchCheck.jsp">
  	...
  	<h2 align="center">卸妆水类信息</h2>
		<table align="center" width="700" class="table table-striped">
		<thead>	
			<tr>
				<td>编号</td>
				<td>名称</td>
			...
			String sql="select * from cusbeauty where petCategory = 'cleanwater'";
    	...
    	<div align="center">
            ...
            <div align="center">
                <%
                  ...
                  {
                    %>
                &nbsp;<a href="tortoise.jsp?page=1">首页</a>&nbsp;
                &nbsp;<a href="tortoise.jsp?page=<%=intPage-1%>">上一页</a>&nbsp;
                <%
                    if(intPage >3)
                    {
                %>
                ...
                <%
                    ...
                    {
                %>
                &nbsp;<a href="tortoise.jsp?page=<%=intPage-2%>"><%=intPage-2%></a>&nbsp;
                <%
                    }
                %>
                &nbsp;<a href="tortoise.jsp?page=<%=intPage-1%>"><%=intPage-1%></a>&nbsp;
                <%
                  }
                %>
                &nbsp;<a href="tortoise.jsp?page=<%=intPage%>" style="color: red"><%=intPage%></a>&nbsp;
                <%
                    if(intPage<intPageCount){
                %>
                &nbsp;<a href="tortoise.jsp?page=<%=intPage+1%>"><%=intPage+1%></a>&nbsp;
                ...
                %>
                &nbsp;<a href="tortoise.jsp?page=<%=intPage+1%>">下一页</a>&nbsp;
                &nbsp;<a href="tortoise.jsp?page=<%=intPageCount%>">尾页</a>&nbsp;
                <%
                    }
                %>
                &nbsp;共<%=intPageCount%>页
    		...
    		st.close();
     		con.close();
   		%>
   		输入彩妆名称<input type="text" name="petName" size="20">
