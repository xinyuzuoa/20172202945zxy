  ...
  <form action="searchCheck.jsp">
  	<table align="center" width="500">		
		...
		<thead>	
			...
			String sql="select * from cusbeauty where petCategory = 'pink'";
    	...
    	<div align="center">
            ...
            <div align="center">
                <%
                  ...
                  {
                    %>
                &nbsp;<a href="mouse.jsp?page=1">首页</a>&nbsp;
                &nbsp;<a href="mouse.jsp?page=<%=intPage-1%>">上一页</a>&nbsp;
                <%
                    if(intPage >3)
                    {
                %>
                ...
                <%
                    ...
                    {
                %>
                &nbsp;<a href="mouse.jsp?page=<%=intPage-2%>"><%=intPage-2%></a>&nbsp;
                <%
                    }
                %>
                &nbsp;<a href="mouse.jsp?page=<%=intPage-1%>"><%=intPage-1%></a>&nbsp;
                <%
                  }
                %>
                &nbsp;<a href="mouse.jsp?page=<%=intPage%>" style="color: red"><%=intPage%></a>&nbsp;
                <%
                    if(intPage<intPageCount){
                %>
                &nbsp;<a href="mouse.jsp?page=<%=intPage+1%>"><%=intPage+1%></a>&nbsp;
                ...
                %>
                &nbsp;<a href="mouse.jsp?page=<%=intPage+1%>">下一页</a>&nbsp;
                &nbsp;<a href="mouse.jsp?page=<%=intPageCount%>">尾页</a>&nbsp;
                <%
                    }
                %>
                &nbsp;共<%=intPageCount%>页
    		...
    		st.close();
     		con.close();
   		%>
   		输入美妆姓名<input type="text" name="petName" size="20">
